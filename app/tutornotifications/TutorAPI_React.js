...
//import PushNotificationContainer from 'PATH/TO/CONTAINER'
...
/*
		React port of implementation of SI sessions and class schedule
		getting connected and parsed through from json endpoints
*/

class TutorAPI_React extends React.Component {
    constructor(props) {
        super(props);
        this.getAPI();
    }
